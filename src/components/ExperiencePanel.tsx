...
export function ExperiencePanel({ experience }: { experience: ExperienceItem[] }) {
  return (
    <section id="experience" className="relative overflow-hidden rounded-[10px] border border-[var(--border)] bg-white/[0.012] p-[54px_20px_20px] shadow-[inset_0_0_20px_rgba(255,255,255,0.015)]">
